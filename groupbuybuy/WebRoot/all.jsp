				...
				<div id="bd" class="cf">
					<div id="forum">
						<div class="dashboard" id="dashboard">
							<ul>
								<li class="current">
									<a href="talkwithservlet?action=list&city=${city}">所有</a><span></span>
								</li>
							...
							<div class="box clear">
								...
								<div class="box-content">
									<div class="head">
										...
										<ul class="filter">
											<li>
												<a href="newTopic.jsp?city=${city}">＋发表新话题</a>
											</li>
										</ul>
									</div>
									<div class="sect">
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<tr class="alt">
													...
													<td align="center" nowrap>
														<a href="answerservlet?action=listanswer&talkId=<%=tw.getTalkid()%>&city=${city}">查看回复</a>
													</td>

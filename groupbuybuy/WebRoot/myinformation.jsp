...
<html xmlns="http://www.w3.org/1999/xhtml" id="">
	<head>
		...
		<title>沃 - 精品团购每一天 |${city}购物|${city}团购|${city}打折</title>
							...
							<div class="box clear">
								...
								<div class="box-content">
									<div class="head">
										...
										<ul class="filter">
											<li>
												<a href="userservlet?action=queryById&id=<%=u.getUserId() %>&city=<%=city %>">修改资料</a>
											</li>
										</ul>
									</div>
									<div class="sect">
											...
											<div class="field">
												<a href="userservlet?action=queryById&id=<%=u.getUserId() %>&city=<%=city %>">继续完善资料</a>
											</div>
											<%}else{%>
											<div class="field">
												<label>

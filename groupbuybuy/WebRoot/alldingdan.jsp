				...
				<div id="bd" class="cf">
					<div id="coupons">
						<div class="dashboard" id="dashboard">
							<ul>
								<li class="current">
									<a href="orderitemservlet?action=queryByUser&username=<%=userName%>">我的订单</a><span></span>
								</li>
								<li>
...
<!-- 											
 ...
 -->											
											<li >
												<a href="orderitemservlet?action=queryByUser&username=<%=userName%>&city=${city}">全部</a>
											</li>
											<li>
												<a href="orderitemservlet?action=queryByStatus&status=0&username=<%=userName%>&city=${city}">未付款</a>
											</li>
											<li>
												<a href="orderitemservlet?action=queryByStatus&status=1&username=<%=userName%>&city=${city}">已付款</a>
											</li>
										</ul>
									</div>
									<div class="sect">
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<c:forEach items="${requestScope.list}" var="d">
												...
												<tr class="alt">
													...
													<c:choose>
														<c:when test="${d.oitemStatus=='未付款'}">
															<td class="op" width="120px">
																<a href="yaofukuan.jsp?totalPrice=${d.amount*d.pro.proTprice }&oitemId=${d.oitemId}">付款</a>
																<a href="orderitemservlet?action=delete&proId=${d.oitemId}&username=<%=userName%>">取消</a>
															</td>
														</c:when>
														<c:otherwise>
															<td class="op" width="120px">
																<a href="produceservlet?action=query&proId=${d.pro.proId} ">查看</a>
															</td>
														</c:otherwise>
													</c:choose>

<%@ page language="java" import="java.util.*,org.cw.group.bean.*,org.cw.group.dao.*"
	pageEncoding="GBK"%>
		...
		<div id="bdw" class="bdw">
			...
			<div id="bd" class="cf">
				<div id="sysmsg-guide">
					...
					<a id="sysmsg-guide-close" href="javascript:close();" class="close">关闭</a>
				</div>
				<div id="recent-deals">
					<div id="content">
						<div class="box">
												...
												<div style="height: 50px; overflow: hidden">
													<h4>
														<a href="http://localhost/mt/team.php?id=4"
															title="${p.proTitle}" target="_blank"></a>
													</h4>
												</div>
												<div class="pic">
													<div class="isopen"></div>
													<a target="_blank"
														href="produceservlet?action=query&proId=${p.proId}&city=${city}"> <img
															alt="${p.proTitle} " src="images/${p.proImg2}"
															width="200" height="121" /> </a>
												</div>
												<div class="info">
												<%-- 	<p class="total">
														<strong class="count">${p.proBuyAmount}</strong>人购买
													</p>--%>
													<p class="price">
														原价：
														<strong class="old"><span class="money"></span>${p.proMprice}</strong>
														<br />
														折扣：
														<strong class="discount"><fmt:formatNumber
																value="${p.proTprice/p.proMprice*10}" pattern="#0.0#" />
														</strong>
														<br />
														现价：
														<strong><span class="money"></span>${p.proTprice}</strong>
														<br />
														<strong><span><a target="_blank"
																rel="nofollow"
																href="produceservlet?action=query1&proId=${p.proId}&city=${city}">购买</a>
														</span>
														</strong>
														<br />

								...
								<div class="box-content">
									...
									<div class="sect">
										...
										<table id="replies-list" cellspacing="0" cellpadding="0"
												...
												<tr>
													...
													<td width="660">
														...
														<div class="author">
															...
															<span style="float: right;">${a.aTime} </span><b>${a.aUser}</b>
															<div class="clear"></div>
														</div>
											...
											<form action="answerservlet?action=insert&talkId=${talkId}&userName=<%=userName%>&city=${city}" method="post">
											<tr>
											<td>我也说说</td>
											</tr>
											<tr>
												<td colspan="2">
													<div style="float: left;">
														<textarea cols="90" rows="5" name="content"
											...
											<tr>
												<td colspon="2">
													<input type="submit" value="回复" name="commit"
